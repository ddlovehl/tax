...
@RestController
@RequestMapping("/v1/accountDetailAdmin")
public class AccountDetailController {

        private AccountDetailBizService accountDetailBizService;
    ...
    public String queryById(@RequestBody JSONObject obj) throws Exception {
        ...
        //AccountDetail accountDetail = accountDetailBizService.queryById(new BigInteger(req.getId()));
