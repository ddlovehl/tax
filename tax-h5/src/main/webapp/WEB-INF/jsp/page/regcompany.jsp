	...
	<div class="main regconpany">
		<div class="mainTop">
			<div class="swiper-container navswiper">
			    ...
			    <div class="swiper-wrapper">
		            <div class="swiper-slide" style="background-image:url(${ctx}/static/img/index/regcompany1.png)"></div>
		            <div class="swiper-slide" style="background-image:url(${ctx}/static/img/index/regcompany2.png)"></div>
		            <div class="swiper-slide" style="background-image:url(${ctx}/static/img/index/regcompany3.png)"></div>
		            <div class="swiper-slide" style="background-image:url(${ctx}/static/img/index/regcompany4.png)"></div>
		            <div class="swiper-slide" style="background-image:url(${ctx}/static/img/index/regcompany5.png)"></div>
		            <div class="swiper-slide" style="background-image:url(${ctx}/static/img/index/regcompany6.png)"></div>
			    </div>
		  	</div>
		</div>
